...
var product = {
  name: 'Dat',
  id: 2025,
  deliveryAddress: 'Somewhere in Newyork',
  product: 'some electronic product',
}
...
//var person1 = new PerInfo()
var person2 = Object.create(PerInfo)
console.log(person2.getPersonalDetails())
// Inherit should be done both way's constructor and Object.Create
// Create three objects and merge their propeties
var dog = { name: 'x', age: '5', nickName: 'chuchu' }
var robot = { name: 'robocop', RId: 2343, friendly: true }

var hybrid = Object.assign({}, PerInfo, dog, robot)
console.log(hybrid)
